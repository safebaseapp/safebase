...
,
{
  ...
  "tr": {
    ...
    "objective_title": "AMAÇ",
    "objective": "Çalışanların hareket eden, düşen, dönen, fırlayan veya basınç altında serbest kalabilecek ekipman ve malzemelerin hareket hattından uzak tutulmasını sağlamak.",
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Bir ekipmanın hareket edebileceği hattın üzerinde veya karşısında durmayın.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls": [
      "İşe başlamadan hareket hattını belirleyin.",
      "Çalışanları yük ve ekipman hareket yolundan ayırın.",
      "Askıdaki yüklerin altında veya yanında durmayın.",
      "Basınçlı bağlantıların karşısında durmayın.",
      "Dönen ekipmanın süpürme alanını bariyerleyin.",
      "Malzemeyi elle yönlendirmek yerine uygun yardımcı araç kullanın.",
      "Araç ve ekipman kör noktalarından uzak durun.",
      "Beklenmeyen hareketi önlemek için enerjiyi izole edin.",
      "Bariyer ve dışlama bölgelerini koruyun.",
      "Kontrolsüz hareket ihtimalinde işi durdurun."
    ],
    ...
    "verification": [
      "Hareket hattı belirlendi",
      "Dışlama alanı kuruldu",
      "Askıdaki yük alanı boş",
      "Basınçlı ekipman kontrol edildi",
      "Kör noktalar belirlendi",
      "Enerji izolasyonu uygun",
      "Bariyerler yerinde",
      "İletişim yöntemi belirlendi",
      "Kaçış yolu açık",
      "Ekip bilgilendirildi"
    ],
    "attendance_title": "KATILIM VE ONAY",
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Keep personnel clear of the travel path of moving, falling, rotating, swinging or suddenly released equipment and materials.",
    ...
    "remember_title": "REMEMBER",
    "remember": "Never position yourself where stored energy or moving equipment can travel toward you.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
    ...
    "controls": [
      "Identify the line of fire before work starts.",
      "Separate personnel from equipment and load travel paths.",
      "Never stand beneath or beside suspended loads.",
      "Stay clear of pressurised connections and release paths.",
      "Barricade the swing radius of rotating equipment.",
      "Use suitable handling tools instead of hands where possible.",
      "Remain outside vehicle and equipment blind spots.",
      "Isolate energy that could cause unexpected movement.",
      "Maintain barriers and exclusion zones.",
      "Stop work whenever movement cannot be controlled."
    ],
    ...
    "verification": [
      ...
      "Suspended-load area clear",
      "Pressurised equipment checked",
      "Blind spots identified",
      "Energy isolation adequate",
      "Barriers in place",
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "El ve parmakların hareketli parçalar, ekipman, borular ve sabit yüzeyler arasında sıkışmasını veya ezilmesini önlemek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Elinizi bir parçanın hareket edebileceği veya kapanabileceği noktaya koymayın.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls": [
      ...
      "Elleri iki yüzey arasından uzak tutun.",
      "Parçaları elle hizalamak yerine uygun aparat kullanın.",
      "Malzemeyi hareket öncesi sabitleyin.",
      "Beklenmeyen hareket yaratabilecek enerjiyi izole edin.",
      "Dönen ve hareketli parçaların muhafazalarını koruyun.",
      "Ağır parçaları elle tutarak konumlandırmayın.",
      "Uygun eldiven kullanın ancak eldivene güvenmeyin.",
      "Ekip hareketlerinde tek ve net iletişim kullanın.",
      "Kontrolsüz hareket ihtimalinde işi durdurun."
    ],
    "supervisor_title": "AMİRİN MESAJI",
    ...
    "verification": [
      ...
      "Enerji kontrol edildi",
      "Parça sabitlendi",
      "Hizalama aparatı mevcut",
      "Muhafazalar yerinde",
      "Eller hareket hattı dışında",
      "İletişim yöntemi belirlendi",
      "KKD uygun",
      "Çalışma alanı yeterli",
      "Ekip bilgilendirildi"
    ],
    "attendance_title": "KATILIM VE ONAY",
    "fields": [
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Prevent hand and finger injuries caused by trapping or crushing between moving components, equipment, pipework and fixed surfaces.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "Never place your hand where a component can move, close or shift against another surface.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
    ...
    "controls": [
      ...
      "Keep hands clear of opposing surfaces.",
      "Use alignment tools instead of fingers or hands.",
      "Secure components before movement.",
      "Isolate energy capable of unexpected movement.",
      "Keep guards fitted to moving machinery.",
      "Do not support heavy components by hand during positioning.",
      "Wear suitable gloves but never rely on gloves as the primary control.",
      "Use one clear communication method during coordinated movement.",
      "Stop work if movement cannot be controlled."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Yürüme ve çalışma alanlarında kayma, takılma ve aynı seviyede düşme risklerini ortadan kaldırmak.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Gördüğünüz takılma tehlikesini yalnızca geçmeyin; kaldırın veya emniyete alın.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls_title": "KONTROLLER",
    "controls": [
      "Yürüme yollarını açık tutun.",
      "Dökülmeleri hemen temizleyin.",
      "Kablo ve hortumları geçiş yollarından uzaklaştırın.",
      "Malzemeleri belirlenmiş alanlarda depolayın.",
      "Hasarlı zemin ve açıklıkları işaretleyin ve koruyun.",
      "Merdivenlerde korkuluk kullanın.",
      "Yeterli aydınlatma sağlayın.",
      "Uygun kaymaz iş ayakkabısı kullanın.",
      "Telefon kullanarak yürümeyin.",
      "Düzeltilemeyen tehlikeyi bariyerleyip bildirin."
    ],
    "supervisor_title": "AMİRİN MESAJI",
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Eliminate slip, trip and same-level fall hazards from access routes and working areas.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "Do not simply step over a trip hazard; remove it or make the area safe.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
    ...
    "controls": [
      ...
      "Route cables and hoses away from pedestrian paths.",
      "Store materials only in designated areas.",
      "Mark and protect damaged floors and openings.",
      "Use handrails on stairs.",
      "Provide adequate lighting.",
      "Wear suitable slip-resistant safety footwear.",
      "Do not walk while distracted by a phone.",
      "Barricade and report hazards that cannot be immediately corrected."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Araç ve mobil ekipmanların çalışanlarla etkileşiminden kaynaklanan çarpma ve ezilme risklerini kontrol etmek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Operatörün sizi gördüğünü varsaymayın; yaklaşmadan önce pozitif iletişim kurun.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
      "Araç kör noktaları.",
      "Geri manevra.",
    ...
    "controls_title": "KONTROLLER",
    "controls": [
      "Araç ve yaya yollarını fiziksel olarak ayırın.",
      "Belirlenmiş yaya yollarını kullanın.",
      "Araç kör noktalarından uzak durun.",
      "Geri manevrada gerektiğinde banksman kullanın.",
      "Operatörle göz teması veya pozitif iletişim kurun.",
      "Hız limitlerini uygulayın.",
      "Geri görüş ve ikaz sistemlerini kontrol edin.",
      "Yüksek görünürlüklü kıyafet kullanın.",
      "Park edilen ekipmanı emniyete alın.",
      "Ayrım sistemi bozulduğunda araç hareketini durdurun."
    ],
    "supervisor_title": "AMİRİN MESAJI",
    ...
    "verification": [
      ...
      "Bariyerler yerinde",
      "Banksman belirlendi",
      "Kör noktalar kontrol edildi",
      "İkaz sistemleri çalışıyor",
      "Hız kontrolü mevcut",
      "Hi-vis uygun",
      "Park alanı güvenli",
      "Ekip bilgilendirildi"
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Control struck-by and crushing risks created where vehicles and mobile equipment interact with pedestrians.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "Never assume an operator has seen you; establish positive communication before approaching.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
      "Vehicle blind spots.",
      "Reversing movements.",
    ...
    "controls_title": "CONTROLS",
    "controls": [
      "Physically separate vehicle and pedestrian routes.",
      "Use designated pedestrian walkways.",
      "Stay outside vehicle blind spots.",
      "Use a banksman for reversing where required.",
      "Establish eye contact or positive communication with operators.",
      "Enforce site speed limits.",
      "Check reversing aids and warning devices.",
      "Wear high-visibility clothing.",
      "Secure parked equipment against movement.",
      "Stop vehicle movement if segregation controls fail."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
    ...
    "verification_title": "FIELD VERIFICATION",
    "verification": [
      "Pedestrian route defined",
      "Vehicle route defined",
      "Barriers in place",
      "Banksman assigned",
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Basınçlı gaz tüplerinin depolanması, taşınması ve kullanımı sırasında yangın, patlama, kaçak ve fırlama risklerini kontrol etmek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Hasarlı vana, basınçlı tüpü kontrolsüz bir fırlama tehlikesine dönüştürebilir.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
      "Tüp devrilmesi.",
      "Valf kırılması.",
    ...
    "controls": [
      ...
      "Kullanılmayan tüplerde vana koruyucu başlığını takın.",
      "Oksijen ve yanıcı gazları uygun şekilde ayırın.",
      "Tüpleri ısı ve tutuşturma kaynaklarından uzak tutun.",
      "Doğru regülatör ve bağlantıları kullanın.",
      "Kaçak kontrolünü uygun yöntemle yapın.",
      "Tüpleri vanasından kaldırmayın veya sürüklemeyin.",
      "Taşıma için uygun tüp arabası kullanın.",
      "Hasarlı veya kaçak tüpleri kullanımdan kaldırın.",
      "Vanaları kullanım sonrası kapatın."
    ],
    "supervisor_title": "AMİRİN MESAJI",
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Control fire, explosion, leakage and projectile hazards during the storage, handling and use of compressed-gas cylinders.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "A damaged valve can turn a pressurised cylinder into an uncontrolled projectile.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
      "Cylinder falling.",
      "Valve breakage.",
    ...
    "controls_title": "CONTROLS",
    "controls": [
      "Keep cylinders upright and securely restrained.",
      "Fit valve-protection caps when cylinders are not in use.",
      "Separate oxygen and fuel gases as required.",
      "Keep cylinders away from heat and ignition sources.",
      "Use the correct regulator and connections.",
      "Check for leakage using an approved method.",
      "Never lift or drag a cylinder by its valve.",
      "Use a suitable cylinder trolley for transport.",
      "Remove damaged or leaking cylinders from service.",
      "Close cylinder valves after use."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
    ...
    "verification": [
      ...
      "Hoses sound",
      "No leakage",
      "Cylinder trolley available",
      "Damaged cylinders isolated",
      "Crew briefed"
    ],
    "attendance_title": "ATTENDANCE AND APPROVAL",
    "fields": [
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Hidrostatik veya pnömatik basınç testlerinde depolanan enerjinin kontrolsüz serbest kalmasını önlemek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Basınç altındaki bağlantıyı sıkmayın ve kaçağı elinizle aramayın.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls_title": "KONTROLLER",
    "controls": [
      "Onaylı test prosedürünü kullanın.",
      "Test sınırlarını doğrulayın.",
      "Kalibre edilmiş manometre kullanın.",
      "Bağlantı, hortum ve körleri test öncesi kontrol edin.",
      "Dışlama alanı oluşturun.",
      "Basıncı kontrollü ve kademeli artırın.",
      "Potansiyel fırlama hattından uzak durun.",
      "Basınç altında bağlantı ayarı yapmayın.",
      "Anormal basınç kaybında testi durdurun.",
      "Müdahale öncesi sistemi tamamen basınçsız hale getirin."
    ],
    "supervisor_title": "AMİRİN MESAJI",
    ...
    "verification_title": "SAHA DOĞRULAMASI",
    "verification": [
      "Test prosedürü mevcut",
      "Sınırlar doğrulandı",
      "Manometre kalibre",
      "Bağlantılar kontrol edildi",
      "Körler uygun",
      "Dışlama alanı kuruldu",
      "Personel alan dışında",
      "İletişim yöntemi belirli",
      "Tahliye yöntemi hazır",
      "Ekip bilgilendirildi"
    ],
    "attendance_title": "KATILIM VE ONAY",
    "fields": [
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Prevent uncontrolled release of stored energy during hydrostatic or pneumatic pressure testing.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "Never tighten a pressurised connection or search for a leak with your hand.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
    ...
    "controls_title": "CONTROLS",
    "controls": [
      "Use an approved test procedure.",
      "Verify the test boundaries.",
      "Use calibrated pressure gauges.",
      "Inspect connections, hoses and blinds before testing.",
      "Establish an exclusion zone.",
      "Increase pressure gradually and under control.",
      "Remain clear of potential projectile paths.",
      "Never adjust connections while pressurised.",
      "Stop the test following abnormal pressure loss.",
      "Fully depressurise before intervention."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Taşlama ve kesme işlerinde disk kırılması, geri tepme, kıvılcım, kesilme ve fırlayan parçacık risklerini kontrol etmek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Yanlış veya hasarlı disk yüksek devirde parçalanarak ölümcül fırlayan parçalara dönüşebilir.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls_title": "KONTROLLER",
    "controls": [
      "Diski kullanımdan önce kontrol edin.",
      "Disk tipini yapılan işe uygun seçin.",
      "Disk devir değerinin makineye uygunluğunu doğrulayın.",
      "Muhafazayı çıkarmayın veya değiştirmeyin.",
      "İş parçasını sabitleyin.",
      "Kıvılcım yönünü insan ve yanıcı malzemelerden uzak tutun.",
      "Gözlük ve yüz siperi kullanın.",
      "İki elle güvenli tutuş sağlayın.",
      "Disk değişiminden önce enerjiyi kesin.",
      "Anormal titreşim veya sıkışmada ekipmanı durdurun."
    ],
    "supervisor_title": "AMİRİN MESAJI",
    ...
    "verification": [
      ...
      "Muhafaza yerinde",
      "İş parçası sabit",
      "Kıvılcım yönü güvenli",
      "Yanıcı malzeme kontrol edildi",
      "KKD uygun",
      "Kablo güvenli",
      "Ekip bilgilendirildi"
    ],
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Control wheel failure, kickback, sparks, cutting and flying-particle hazards during grinding and cutting work.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "An incorrect or damaged wheel can fragment at high speed and become a lethal projectile.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
    ...
    "controls": [
      ...
      "Verify wheel speed rating against tool speed.",
      ...
      "Maintain a secure two-handed grip.",
      "Disconnect energy before changing wheels.",
      "Stop the tool for abnormal vibration or binding."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Kaynak sırasında oluşan metal dumanı, gaz ve partiküllerin solunmasını kaynağında kontrol etmek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Dumanı görememeniz havanın güvenli olduğu anlamına gelmez.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls_title": "KONTROLLER",
    "controls": [
      "Kaynak yapılacak metal ve kaplamayı belirleyin.",
      "Uygun olmayan kaplamaları güvenli şekilde temizleyin.",
      "Lokal emiş havalandırması kullanın.",
      "Yeterli genel havalandırma sağlayın.",
      "Başınızı duman bulutundan uzak tutun.",
      "Gerektiğinde uygun solunum koruması kullanın.",
      "Filtre seçimi ve fit testini doğrulayın.",
      "Kapalı alanlarda atmosferi izleyin.",
      "İşe başlamadan LEV çalışmasını kontrol edin.",
      "Kontroller yetersizse işi durdurun."
    ],
    "supervisor_title": "AMİRİN MESAJI",
    ...
    "verification": [
      ...
      "LEV mevcut",
      "LEV çalışıyor",
      "Genel havalandırma yeterli",
      "Solunum KKD uygun",
      "Fit test uygun",
      "Filtre doğru",
      "Atmosfer kontrol edildi",
      "Ekip bilgilendirildi"
    ],
    "attendance_title": "KATILIM VE ONAY",
    "fields": [
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Control inhalation of metal fumes, gases and particulates generated during welding at source.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "The absence of visible welding fume does not mean the atmosphere is safe.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
    ...
    "controls": [
      ...
      "Safely remove unsuitable coatings.",
      ...
      "Verify filter selection and fit testing.",
      "Monitor the atmosphere in confined areas.",
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Sıcak, nem, güneş, ağır iş yükü ve KKD nedeniyle oluşabilecek sıcak stresi ve sıcak çarpmasını önlemek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Baş dönmesi, koordinasyon bozukluğu veya bilinç değişikliği acil uyarı işaretidir.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls_title": "KONTROLLER",
    "controls": [
      "Sıcaklık ve iş yükünü değerlendirin.",
      "Düzenli su tüketimini sağlayın.",
      "Planlı dinlenme molaları uygulayın.",
      "Gölge veya serin dinlenme alanı sağlayın.",
      "Ağır işleri mümkünse serin saatlere planlayın.",
      "Yeni çalışanların sıcaklığa alışma sürecini yönetin.",
      "Uygun hafif iş kıyafeti kullanın.",
      "Çalışanları birbirlerini gözlemlemeleri için eşleştirin.",
      "Sıcak stres belirtilerini takip edin.",
      "Belirti görüldüğünde işi durdurup acil müdahaleyi başlatın."
    ],
    "supervisor_title": "AMİRİN MESAJI",
    ...
    "verification_title": "SAHA DOĞRULAMASI",
    "verification": [
      "Sıcaklık değerlendirildi",
      "Su mevcut",
      "Mola planı var",
      "Serin alan mevcut",
      "İş yükü uygun",
      "Aklimatizasyon kontrol edildi",
      "KKD değerlendirildi",
      "Buddy sistemi mevcut",
      "Belirtiler anlatıldı",
      "Ekip bilgilendirildi"
    ],
    "attendance_title": "KATILIM VE ONAY",
    "fields": [
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Prevent heat stress and heat illness caused by temperature, humidity, direct sun, workload and PPE.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "Dizziness, poor coordination or altered mental state are serious warning signs.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
    ...
    "controls_title": "CONTROLS",
    "controls": [
      "Assess temperature and workload.",
      "Provide regular access to drinking water.",
      "Implement planned recovery breaks.",
      "Provide shade or a cool recovery area.",
      "Schedule heavy work for cooler periods where practicable.",
      "Manage acclimatisation of new workers.",
      "Use suitable lightweight work clothing where permitted.",
      "Use a buddy system to observe workers.",
      "Monitor for heat-stress symptoms.",
      "Stop work and initiate emergency response when serious symptoms appear."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
    ...
    "verification": [
      "Heat assessed",
      "Water available",
      "Break plan established",
      "Cool area available",
      "Workload suitable",
      "Acclimatisation checked",
      "PPE assessed",
      "Buddy system active",
      "Symptoms explained",
      "Crew briefed"
...
},
{
  ...
  "tr": {
    ...
    "duration": "8–10 dakika",
    "objective_title": "AMAÇ",
    "objective": "Soğuk, rüzgâr ve ıslak koşullarda hipotermi, donma ve el becerisi kaybını önlemek.",
    "explanation_title": "NEDEN ÖNEMLİ?",
    "explanation": [
    ...
    "remember_title": "UNUTMAYIN",
    "remember": "Kontrolsüz titreme, uyuşma veya kafa karışıklığı normal soğuk hissi değildir.",
    "hazards_title": "TEMEL TEHLİKELER",
    "hazards": [
    ...
    "controls_title": "KONTROLLER",
    "controls": [
      "Hava sıcaklığı ve rüzgârı değerlendirin.",
      "Kuru ve katmanlı kıyafet kullanın.",
      "El, ayak ve başı koruyun.",
      "Islanan kıyafeti değiştirin.",
      "Planlı sıcak alan molaları uygulayın.",
      "Uzun süre hareketsiz çalışmayı azaltın.",
      "Soğuk metal ile doğrudan teması önleyin.",
      "Çalışanları buddy sistemiyle takip edin.",
      "Hipotermi ve donma belirtilerini izleyin.",
      "Belirti görüldüğünde işi durdurup çalışanı sıcak alana alın."
    ],
    "supervisor_title": "AMİRİN MESAJI",
  ...
  "en": {
    ...
    "duration": "8–10 minutes",
    "objective_title": "OBJECTIVE",
    "objective": "Prevent hypothermia, cold injury and loss of dexterity during work in cold, windy or wet conditions.",
    "explanation_title": "WHY IT MATTERS",
    "explanation": [
    ...
    "remember_title": "REMEMBER",
    "remember": "Uncontrolled shivering, numbness or confusion is not a normal response to cold.",
    "hazards_title": "KEY HAZARDS",
    "hazards": [
      "Low air temperature.",
      "High wind speed.",
    ...
    "controls_title": "CONTROLS",
    "controls": [
      "Assess temperature and wind conditions.",
      "Wear dry layered clothing.",
      "Protect hands, feet and head.",
      "Replace wet clothing promptly.",
      "Provide planned warm-up breaks.",
      "Reduce prolonged stationary work.",
      "Avoid direct contact with cold metal.",
      "Use a buddy system to monitor workers.",
      "Watch for hypothermia and frostbite symptoms.",
      "Stop work and move affected workers to a warm area."
    ],
    "supervisor_title": "SUPERVISOR MESSAGE",
    ...
    "verification": [
      ...
      "Clothing dry",
      "Layers suitable",
      "Hand protection suitable",
      "Foot protection suitable",
      "Warm area available",
      "Break plan established",
      "Buddy system active",
      "Symptoms explained",
