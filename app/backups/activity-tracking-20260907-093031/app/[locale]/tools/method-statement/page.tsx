...
export default function MethodStatementPage({ params }: Props) {
  ...
  const handlePrintMethodStatement = () => {
    trackEvent("pdf_downloaded", {
      ...
      locale,
      template_id: activeTemplateName || loadedTemplate || "custom",
      step_count: methodSteps.length,
      source: "method_statement_generator",
    });
  ...
  const loadWorkingAtHeightTemplate = () => {
    ...
    trackEvent("method_statement_created", {

      locale,

      template_id: "working-at-height",
...
{/* SERNEM_METHOD_LIBRARY_START */}
        ...
        >
          <button
            type="button"
            onClick={handlePrintMethodStatement}
