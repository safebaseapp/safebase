...
export default function WorkAtHeightChecklist({ locale }: Props) {
  ...
  function runSafetyAnalysis() {
    trackEvent("ai_assessment_used", {
      assessment_type: "work_at_height_checklist",
      locale,
  ...
  async function generateAiAssessment() {
    trackEvent("premium_ai_assessment_used", {
      assessment_type: "working_at_height",
      locale,
      answered_count: answeredCount,
      total_items: items.length,
      findings_count: noCount,
      critical_findings: criticalFailures.length,
      source: "working_at_height_premium_ai",
    });
    ...
    try {
      const result = await generateAssessment({
        workType: analysis.checklistTitle || "Working at Height",
        language: locale,
      ...
      console.error("Working at Height AI Assessment Error:", error);
