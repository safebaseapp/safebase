...
export default function DownloadsPage() {
  ...
  const categories = [
    ...
    {
      id: "posters",
      label: isTurkish ? "Posterler" : "Posters",
      count: downloads.filter((item) => item.category === "posters").length,
    },
    {
      id: "toolbox-talks",
  ...
  const categoryLabel = (category: DownloadItem["category"]) => {
    ...
    if (category === "posters") {
      return isTurkish ? "Poster" : "Poster";
    }
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-20 pt-8 lg:px-8">
          <div className="mx-auto max-w-4xl pb-10 pt-20 text-center lg:pt-24">
            ...
            {isTurkish
            ? "Profesyonel HSE şablonları, rehberler, posterler ve sahada kullanıma hazır indirilebilir kaynakları keşfedin."
            : "Explore professional HSE templates, guides, posters and ready-to-use downloadable resources."}
            </p>
            <div className="mx-auto mt-10 max-w-2xl">
              <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.06] px-5 py-4 shadow-2xl shadow-black/20 backdrop-blur-xl transition focus-within:border-blue-500/40 focus-within:ring-4 focus-within:ring-blue-500/10">
                ...
                <input
                  ...
                  placeholder={
                    isTurkish
                      ? "Şablon, rehber, poster veya toolbox talk ara..."
                      : "Search templates, guides, posters or toolbox talks..."
                  }
