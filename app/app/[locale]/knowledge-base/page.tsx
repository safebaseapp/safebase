            ...
            {featuredArticles.map((article) =>
              article.available ? (
                <Link
                  ...
                  aria-label={`${isTurkish ? "Rehberi aç" : "Open guide"}: ${
                    article.title[locale]
                  }`}
                  className="group relative block h-full overflow-hidden rounded-[26px] border border-white/10 bg-white/[0.045] p-6 transition duration-300 hover:-translate-y-2 hover:border-blue-400/30 hover:bg-white/[0.07] hover:shadow-2xl hover:shadow-blue-950/30 focus:outline-none focus-visible:border-blue-400 focus-visible:ring-4 focus-visible:ring-blue-500/20"
                >
                  ...
                  <div className="relative flex h-full flex-col">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.07] text-blue-300 transition group-hover:border-blue-400/30 group-hover:bg-blue-500/10 group-hover:text-blue-200">
                        <BookIcon />
                      </div>
                    ...
                    <h3 className="mt-3 text-xl font-black leading-tight text-white transition group-hover:text-blue-100">
                      {article.title[locale]}
                    </h3>
                    ...
                    <div className="mt-5 flex items-center justify-between text-xs font-bold text-slate-500">
                      ...
                      <span>{isTurkish ? "Hazır" : "Available"}</span>
                    </div>

                    <div className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 font-black text-white transition group-hover:bg-blue-500">
                ...
                <article
                  key={article.id}
                  className="relative h-full overflow-hidden rounded-[26px] border border-white/10 bg-white/[0.035] p-6 opacity-70"
                >
                  <div className="relative flex h-full flex-col">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.05] text-slate-500">
                        <BookIcon />
                      </div>

                      <span className="rounded-full border border-white/10 bg-white/[0.05] px-3 py-1 text-xs font-black text-slate-500">
                        {article.standard}
                      </span>
                    </div>
                    ...
                    <h3 className="mt-3 text-xl font-black leading-tight text-slate-300">
                      {article.title[locale]}
                    </h3>
                    ...
                    <div className="mt-5 flex items-center justify-between text-xs font-bold text-slate-600">
                      ...
                      <span>{isTurkish ? "Yakında" : "Coming Soon"}</span>
                    </div>
              ...
              {filteredArticles.map((article) =>
                article.available ? (
                  <Link
                    ...
                    className="group flex h-full flex-col rounded-[26px] border border-white/10 bg-white/[0.04] p-6 transition duration-300 hover:-translate-y-1 hover:border-blue-400/30 hover:bg-white/[0.065] hover:shadow-xl hover:shadow-blue-950/20 focus:outline-none focus-visible:border-blue-400 focus-visible:ring-4 focus-visible:ring-blue-500/20"
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.06] text-blue-300 transition group-hover:border-blue-400/30 group-hover:bg-blue-500/10 group-hover:text-blue-200">
                        <BookIcon />
                      </div>
                    ...
                    <h3 className="mt-3 text-xl font-black text-white transition group-hover:text-blue-100">
                      {article.title[locale]}
                    </h3>
                    ...
                    <div className="mt-5 flex items-center justify-between font-black text-blue-400 transition group-hover:text-blue-300">
                      <span>{isTurkish ? "Rehberi Aç" : "Open Guide"}</span>
                  ...
                  <article
                    key={article.id}
                    className="flex h-full flex-col rounded-[26px] border border-white/10 bg-white/[0.03] p-6 opacity-65"
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.05] text-slate-500">
                        <BookIcon />
                      ...
                      <span className="rounded-lg border border-white/10 bg-white/[0.04] px-3 py-1.5 text-xs font-black text-slate-500">
                        {article.standard}
                      </span>
                    </div>
                    ...
                    <h3 className="mt-3 text-xl font-black text-slate-300">
                      {article.title[locale]}
                    </h3>
                    ...
                    <div className="mt-6 flex items-center justify-between border-t border-white/10 pt-5 text-sm font-bold text-slate-600">
                      <span>
                        {article.readTime}{" "}
                        {isTurkish ? "dk okuma" : "min read"}
                      </span>
                    ...
                    <button
                      type="button"
                      disabled
                      className="mt-5 inline-flex cursor-not-allowed items-center justify-between font-black text-slate-600"
                    >
                      <span>{isTurkish ? "Yakında" : "Coming Soon"}</span>
                    </button>
                  </article>
