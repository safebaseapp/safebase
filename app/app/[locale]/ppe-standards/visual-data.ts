...
export const ppeVisuals:Record<string,PPEVisual>={
 ...
 'EN 355':{photo:en355PublicDomain,scenes:[en355PublicDomain,8488021,38346738],glow:'#0891b2',alt:{tr:'Şok emicili lanyardın gerçek saha kullanımı',en:'Real field use of a shock-absorbing lanyard'}},
 ...
 'EN 352':{photo:9242291,scenes:[9242291,8487733,9242291],glow:'#7c3aed',alt:{tr:'Endüstriyel işitme koruyucu kulaklık yakın planı',en:'Close-up of industrial hearing-protection earmuffs'}},
