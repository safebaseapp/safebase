...
export default function LocalizedFeaturedTools({ locale }: Props) {
  ...
  return (
    <section id="tools" className="relative overflow-hidden bg-white px-6 py-14 lg:py-18">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-5 max-w-4xl text-3xl font-black tracking-[-0.04em] text-slate-950 sm:text-6xl">
              {isTurkish
        ...
        <div className="mt-10 overflow-hidden rounded-[32px] border border-blue-200 bg-slate-950 p-6 text-white shadow-2xl shadow-blue-500/10 sm:p-9">
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div>
              ...
              <h3 className="mt-5 text-3xl font-black tracking-tight sm:text-3xl">
                {isTurkish
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {categories.map((category) => (
              <Link
                key={category.title}
                href={category.href}
                className="group rounded-3xl border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-1 hover:border-blue-200 hover:bg-white hover:shadow-xl transition-all duration-300 hover:shadow-blue-950/5 min-h-[170px]"
              >
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {tools.map((tool) => {
            ...
            const cardContent = (
              <article
                className={`group relative flex h-full flex-col overflow-hidden rounded-[24px] border bg-slate-50 p-6 transition duration-300 ${
                  tool.available
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4">
                  <div
                    className={`flex h-12 w-12 items-center justify-center rounded-2xl text-3xl ring-1 transition duration-300 ${styles.icon} ${
        ...
        <div className="mt-10 rounded-[26px] border border-slate-200 bg-slate-50 px-7 py-7 sm:px-8">
