...
export default function LTIFRCalculatorPage() {
  ...
  const result = useMemo(() => {
    const injuries = Number(lostTimeInjuries);
    const hours = Number(hoursWorked);

    if (
      !lostTimeInjuries ||
      !hoursWorked ||
      Number.isNaN(injuries) ||
      Number.isNaN(hours) ||
      injuries < 0 ||
      hours <= 0
    ) {
    ...
    return (injuries * 1_000_000) / hours;
  }, [lostTimeInjuries, hoursWorked]);
        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-xl shadow-black/20 sm:p-8">
            ...
            <p className="mt-4 leading-7 text-slate-400">
              Calculate the Lost Time Injury Frequency Rate using lost time
              injuries and total hours worked.
            </p>

            <div className="mt-8 space-y-6">
              <div>
                <label
                  htmlFor="lost-time-injuries"
          ...
          <div className="space-y-6">
                ...
                {result === null ? (
                  <>
                    ...
                    <p className="mt-2 leading-7 text-slate-400">
                      Enter the number of lost time injuries and total hours
                      worked to calculate LTIFR.
                    </p>
                  </>
                ) : (
                  <>
            ...
            <section className="rounded-3xl border border-slate-800 bg-slate-900 p-6 sm:p-8">
              ...
              <p className="mt-5 leading-7 text-slate-400">
                The 1,000,000-hour base is commonly used for international
                LTIFR reporting.
              </p>
            </section>
