...
if (type === "ladder") {
  ...
  if (type === "inspection") {
    return (
      <svg viewBox="0 0 100 100" className={common} strokeWidth="5.5">
        <rect x="24" y="18" width="52" height="66" rx="8" />
        <path d="M38 18V12h24v6" />
        <path d="M35 43l9 9 20-22" />
        <path d="M35 68h30" />
      </svg>
    );
  }
  ...
  if (type === "ground") {
    return (
      <svg viewBox="0 0 100 100" className={common} strokeWidth="5.5">
        <path d="M31 15L25 73" />
        <path d="M65 15L72 73" />
        <path d="M29 31h38M27 47h42M26 63h45" />
        <path d="M12 78h76" />
        <path d="M18 88h64" />
      </svg>
    );
  ...
  if (type === "angle") {
    return (
      <svg viewBox="0 0 100 100" className={common} strokeWidth="5.5">
        ...
        <path d="M17 82h69" />
        <path d="M61 17l12 65" />
        <path d="M67 67a20 20 0 0 1 13 15" />
      </svg>
    );
  }
  ...
  if (type === "three-point") {
    return (
      <svg viewBox="0 0 100 100" className={common} strokeWidth="5.2">
        <path d="M28 12L22 88M72 12l6 76" />
        <path d="M27 30h46M25 50h50M24 70h52" />
  ...
  if (type === "overreach") {
    return (
      <svg viewBox="0 0 100 100" className={common} strokeWidth="5.2">
        <path d="M24 12L18 88M58 12l7 76" />
        <path d="M22 32h38M21 51h41M19 70h45" />
  ...
  if (type === "barricade") {
    return (
      <svg viewBox="0 0 100 100" className={common} strokeWidth="5.2">
        <path d="M25 14L20 63M58 14l6 49" />
        <path d="M23 30h37M21 47h41" />
        <rect x="10" y="66" width="80" height="16" rx="4" />
        <path d="M20 81v10M80 81v10" />
        <path d="M20 70l12 8M43 70l12 8M66 70l12 8" />
      </svg>
    );
  }
  ...
  if (type === "stop") {
    return (
      <svg viewBox="0 0 100 100" className={common} strokeWidth="5.5">
        <path d="M35 12h30l23 23v30L65 88H35L12 65V35z" />
        <path d="M32 32l36 36" />
        <path d="M68 32L32 68" />
      </svg>
    );
...
function PpeIcon({
  ...
  if (
    ppeTypeValue.includes("harness") ||
    ppeTypeValue.includes("kemer")
  ) {
    return (
      <svg
        viewBox="0 0 100 100"
        className="h-14 w-14 fill-none stroke-slate-950"
        strokeWidth="5"
        strokeLinecap="round"
...
export default function PosterMaster({
  ...
  const ladderCriticalValues = [
    ...
    {
      value: "0,9 m",
      tr: "Üst seviyeye taşma",
      en: "Extension above landing",
    },
    {
      value: "3 NOKTA",
      tr: "Sürekli merdiven teması",
      en: "Three-point contact",
    },
    {
      value: "MAX YÜK",
      tr: "Üretici kapasitesini aşma",
      en: "Do not exceed rated load",
    },
  ];
