...
FORKLIFT_SAFETY = {
    ...
    "tr": {
        ...
        "objective": (
            "Forklift kullanımında devrilme, çarpma, yük düşmesi, kör nokta ve yaya güvenliği "
            "risklerini değerlendirerek güvenli çalışma kurallarını uygulamaktır."
        ),

        "explanation_title": "KONU ANLATIMI",
        "explanation": [
            (
                "Forklift yalnızca eğitimli ve yetkilendirilmiş operatörler tarafından kullanılmalıdır. "
                "Vardiya öncesinde frenler, direksiyon, çatallar, lastikler, korna, geri vites alarmı ve "
                "ikaz lambaları kontrol edilmelidir."
            ),
            (
                "Yük, çatallar üzerinde dengeli taşınmalı ve görüşü kapatacak yüklerle ileri sürüş yapılmamalıdır. "
                "Görüş engelleniyorsa geri sürüş veya spotter kullanılmalıdır."
            ),
            (
                "Forklift hareket halindeyken operatör emniyet kemerini takmalı, hız limitlerine uymalı ve "
                "yayalara her zaman öncelik vermelidir."
            ),
        ],
        ...
        "remember": (
            "Forklift bir taşıma ekipmanıdır, personel taşıma aracı değildir. "
            "Yayalar her zaman önceliklidir."
        ),
        ...
        "supervisor_script": (
            "Bugün forklift kullanan tüm operatörler günlük kontrollerini tamamlayacak. "
            "Yük görüşü engelliyorsa geri sürüş veya spotter kullanılacak. "
            "Yayalara öncelik verilecek, emniyet kemeri takılacak ve hız limitlerine kesinlikle uyulacaktır."
        ),
    ...
    "en": {
        ...
        "objective": (
            "Review forklift hazards including overturning, collisions, dropped loads, blind spots "
            "and pedestrian safety while applying safe operating practices."
        ),
        ...
        "supervisor_script": (
            "Today we will verify daily inspections, ensure seat belts are worn, keep loads low and use spotters where visibility is limited. Pedestrians always have priority."
        ),
