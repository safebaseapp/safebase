...
LADDER_SAFETY = {
    ...
    "tr": {
        ...
        "objective": (
            "Seyyar ve sabit merdivenlerin güvenli kullanımını sağlayarak düşme, kayma, devrilme "
            "ve yanlış kullanım kaynaklı kazaları önlemektir."
        ),

        "explanation_title": "KONU ANLATIMI",
        "explanation": [
            (
                "Merdiven yalnızca kısa süreli ve düşük riskli işler için kullanılmalıdır. Uzun süreli "
                "çalışmalar için platform veya iskele tercih edilmelidir."
            ),
            (
                "Merdiven her kullanımdan önce kontrol edilmeli; çatlak, eğilmiş basamak, gevşek bağlantı "
                "ve kaydırmaz ayak eksikliği varsa kullanılmamalıdır."
            ),
            (
                "Kurulum sırasında 4:1 açısı uygulanmalı, üç temas noktası korunmalı ve merdiven sağlam "
                "bir zemine yerleştirilmelidir. Üst basamakta çalışılmamalı ve yana aşırı uzanılmamalıdır."
            ),
        ],
        ...
        "scenario": [
            ...
            (
                "Doğru açı, sağlam zemin, merdivenin sabitlenmesi ve çalışma pozisyonunun değiştirilmesi "
                "ile olay tamamen önlenebilirdi."
            ),
        ],

        "remember_title": "UNUTMAYIN",
        "remember": (
            "Merdiven sizi işe ulaştırır; çalışma platformunun yerini almaz."
        ),
        ...
        "supervisor_script": (
            "Bugün tüm merdivenler kullanılmadan önce kontrol edilecek. Hasarlı merdiven kullanılmayacak. "
            "4:1 açısı uygulanacak, üç temas noktası korunacak ve kimse üst basamakta çalışmayacak."
        ),
    ...
    "en": {
        ...
        "objective": (
            "Ensure the safe use of portable and fixed ladders while preventing falls, slips, overturning "
            "and misuse."
        ),
        ...
        "supervisor_script": (
            "Today all ladders will be inspected before use. We will apply the 4:1 rule, maintain three points of contact and never work from the top step."
        ),
