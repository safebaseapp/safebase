...
CRANE_BANKSMAN_SAFETY = {
    ...
    "tr": {
        ...
        "objective": (
            "Vinç operatörü, banksman ve kaldırma ekibi arasındaki iletişimi güvenli hale getirmek; "
            "kör kaldırma, yanlış işaret, dönüş yarıçapı, yük altında çalışma ve haberleşme kaybından "
            "kaynaklanan çarpma, sıkışma ve yük düşmesi risklerini önlemektir."
        ),

        "explanation_title": "KONU ANLATIMI",
        "explanation": [
            (
                "Operatöre yalnızca önceden belirlenmiş ve yetkin banksman yön vermelidir. "
                "Birden fazla kişinin komut vermesi karışıklık yaratır ve yükün kontrolsüz hareketine neden olabilir."
            ),
            (
                "Banksman, operatörün ve yükün güvenli görüşünü korumalıdır. Kör kaldırmalarda telsiz veya uygun "
                "haberleşme sistemi kullanılmalı; iletişim kesildiğinde kaldırma hemen durdurulmalıdır."
            ),
            (
                "Acil durdurma işareti herkes tarafından verilebilir. Ancak normal yönlendirme yalnızca atanmış "
                "banksman tarafından yapılmalı ve işaretler işe başlamadan önce ekipçe doğrulanmalıdır."
            ),
        ],
        ...
        "remember": (
            "Operatör banksmanı göremiyor veya haberleşme kesiliyorsa kaldırma durmalıdır. Şüpheli durumda hareket etmeyin."
        ),
        ...
        "supervisor_script": (
            "Arkadaşlar, bugün operatöre yalnızca atanmış banksman yön verecek. El işaretlerini ve telsiz kanalını "
            "işe başlamadan doğrulayacağız. Operatör banksmanı göremezse veya haberleşme kesilirse kaldırma hemen duracak. "
            "Dönüş yarıçapı ve yük altı tamamen boş tutulacak. Acil durdurma işaretini herkes verebilir."
        ),
    ...
    "en": {
        ...
        "objective": (
            "Ensure safe communication between the crane operator, banksman and lifting team, and prevent collision, "
            "crushing and dropped-load hazards caused by blind lifts, conflicting signals, swing-radius exposure "
        ...
        "explanation": [
            (
                "Only the designated and competent banksman should direct the operator. Conflicting instructions "
                "from several people can lead to uncontrolled load movement."
            ),
            (
                "The banksman must maintain safe visibility of the operator and load. Blind lifts require reliable "
                "radio communication, and the lift must stop immediately if communication is lost."
            ),
            (
                "Anyone may give the emergency-stop signal. Normal operating directions, however, must come only "
                "from the appointed banksman using agreed standard signals."
            ),
        ],
        ...
        "scenario": [
            ...
            (
                "The event could have been prevented through the one-signalman rule, an agreed radio channel and "
                "immediate stop on communication loss."
            ),
        ],

        "remember_title": "REMEMBER",
        "remember": (
            "If the operator cannot see the banksman or communication is lost, the lift must stop. Do not move when in doubt."
        ),
        ...
        "supervisor_script": (
            "Team, only the appointed banksman will direct the operator today. We will verify hand signals and radio "
            "channels before starting. If the operator loses sight of the banksman or communication fails, the lift "
            "will stop immediately. The swing radius and suspended-load area will remain clear. Anyone may give the "
