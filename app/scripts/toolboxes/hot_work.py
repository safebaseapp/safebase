...
HOT_WORK = {'base': 'hot-work-toolbox-talk',
 'tr': {'title': 'SICAK ÇALIŞMA TOOLBOX TALK',
        ...
        'objective': 'Kaynak, kesme, taşlama, lehimleme ve kıvılcım oluşturan diğer faaliyetlerde '
                     'yangın, patlama, yanık ve zararlı duman risklerini ekiple birlikte '
                     'değerlendirmek ve işe başlamadan önce gerekli kontrolleri doğrulamak.',
        'explanation_title': 'KONU ANLATIMI',
        'explanation': ['Sıcak çalışma, açık alev oluşturan işlerle sınırlı değildir. Taşlama, '
                        'metal kesme ve sıcak yüzey oluşturan işlemler de kıvılcım, cüruf veya '
                        'yüksek sıcaklık nedeniyle yangın başlatabilir.',
                        'Kıvılcımlar çalışma noktasında kalmaz. Platform boşluklarından, kablo '
                        'geçişlerinden ve açıklıklardan alt veya bitişik alanlara ulaşabilir. '
                        'Yanıcı malzeme görünürde olmasa bile izolasyon, toz, yağ kalıntısı veya '
                        'atıklar gizli yanma oluşturabilir.',
                        'Bu nedenle sıcak çalışma yalnızca geçerli izin, uygun gaz ölçümü, yanıcı '
                        'maddelerin kontrolü, hazır söndürme ekipmanı ve görevini bilen yangın '
                        'gözcüsü bulunduğunda başlatılmalıdır. İş sona erse bile yangın riski '
                        'hemen bitmez.'],
        'scenario_title': 'GERÇEKÇİ SAHA SENARYOSU',
        'scenario': ['Bir bakım ekibi kısa süreli taşlama yaptı. Çalışma alanındaki görünen yanıcı '
                     'maddeler kaldırılmıştı ancak platform altındaki izolasyon malzemesi fark '
                     'edilmedi.',
                     'Kıvılcımlar platform boşluğundan aşağı düştü. Yangın gözcüsü başka bir işle '
                     'meşgul olduğu ve iş sonrası kontrol yapılmadığı için yaklaşık yirmi dakika '
                     'sonra izolasyon tutuştu.',
                     'Olay; üretim kaybına, ekipman hasarına ve acil tahliyeye neden oldu. Uygun '
                     'bariyerleme, bağımsız yangın gözcüsü ve iş sonrası gözetim ile tamamen '
                     'önlenebilirdi.'],
        'remember_title': 'UNUTMAYIN',
        'remember': 'Sıcak çalışma kaynaklı yangınların bir bölümü iş bittikten sonra, gizli kor '
                    'veya ısınmış malzeme nedeniyle başlar.',
        'hazards_title': 'TEMEL TEHLİKELER',
        'hazards': ['Kıvılcım ve cürufun alt veya bitişik alanlara ulaşması.',
        ...
        'controls': ['Geçerli sıcak çalışma iznini doğrulayın.',
        ...
        'supervisor_script': 'Arkadaşlar, bugün yapacağımız kaynak, kesme veya taşlama işi küçük '
        ...
        'questions': ['Bugünkü yangın gözcüsü kim ve tek görevi bu mu?',
 ...
 'en': {'title': 'HOT WORK TOOLBOX TALK',
        ...
        'objective': 'Review fire, explosion, burn and fume hazards associated with welding, '
                     'cutting, grinding, brazing and other spark-producing work, and verify all '
                     'required controls before starting.',
        'explanation_title': 'TOPIC EXPLANATION',
        'explanation': ['Hot work is not limited to activities involving an open flame. Grinding, '
                        'metal cutting and other heat-producing work can start fires through '
                        'sparks, slag and hot surfaces.',
                        'Sparks do not remain at the immediate work point. They can travel through '
                        'platform gaps, penetrations and openings into lower or adjacent areas. '
                        'Hidden insulation, dust, oil residue or waste can smoulder without being '
                        'immediately visible.',
                        'Hot work must therefore begin only when the permit is valid, gas testing '
                        'is acceptable, combustibles are controlled, firefighting equipment is '
                        'ready and a trained fire watch is present. The fire risk continues after '
                        'the task has stopped.'],
        'scenario_title': 'REALISTIC SITE SCENARIO',
        'scenario': ['A maintenance team carried out a short grinding task. Visible combustibles '
                     'had been removed, but insulation below the platform had not been identified.',
                     'Sparks fell through a platform gap. The fire watch was distracted by another '
                     'duty and no post-work inspection was completed. The insulation ignited '
        ...
        'remember': 'Some hot-work fires begin after the task is complete because of hidden embers '
                    'or heated materials.',
        'hazards_title': 'KEY HAZARDS',
        'hazards': ['Sparks and slag reaching lower or adjacent areas.',
        ...
        'controls': ['Verify the approved hot-work permit.',
        ...
        'supervisor_script': "Team, today's welding, cutting or grinding can turn a small spark "
                             'into a major fire. We will not start if the permit is not approved, '
                             'gas testing is unsafe, the fire watch does not understand the role '
                             'or combustibles remain unprotected. We must inspect lower levels and '
        ...
        'questions': ["Who is today's dedicated fire watch?",
