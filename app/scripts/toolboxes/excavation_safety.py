...
EXCAVATION_SAFETY = {
    ...
    "tr": {
        ...
        "objective": (
            "Kazı çalışmalarında göçük, yeraltı tesisatları, düşme, ağır ekipman ve atmosferik "
            "tehlikeleri değerlendirerek güvenli çalışma koşullarını sağlamaktır."
        ),

        "explanation_title": "KONU ANLATIMI",
        "explanation": [
            (
                "Her kazı çalışması başlamadan önce kazı izni, yeraltı hatları ve çalışma yöntemi "
                "doğrulanmalıdır."
            ),
            (
                "1,2 m ve üzerindeki kazılarda uygun koruma yöntemi (şevlendirme, iksa veya trench box) "
        ...
        "remember": (
            "Korumasız kazıya girmek birkaç saniye içinde ölümcül bir göçüğe neden olabilir."
        ),
        ...
        "supervisor_script": (
            "Bugün kazıya girmeden önce izinleri, yeraltı hatlarını ve kazı korumasını birlikte kontrol edeceğiz. "
            "Korumasız kazıya girmeyeceğiz. Kazı kenarında gereksiz personel bulunmayacak ve ağır ekipman güvenli "
            "mesafede çalışacak."
        ),
