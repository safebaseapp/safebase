  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#020817]">
        ...
        <div className="absolute inset-0 -z-20 bg-[linear-gradient(90deg,rgba(2,8,23,0.90)_0%,rgba(2,8,23,0.76)_30%,rgba(2,8,23,0.38)_52%,rgba(2,8,23,0.16)_72%,rgba(2,8,23,0.20)_100%)]" />

        <div className="absolute inset-0 -z-20 bg-[linear-gradient(180deg,rgba(2,8,23,0.08)_0%,rgba(2,8,23,0.02)_66%,rgba(2,8,23,0.48)_100%)]" />
