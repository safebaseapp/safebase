  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#020817]">
        <div
          className="absolute inset-0 -z-30 bg-cover bg-[center_42%] bg-no-repeat scale-[1.08]"
          style={{
            backgroundImage:
        ...
        <div className="absolute inset-0 -z-20 bg-[linear-gradient(180deg,rgba(2,8,23,0.03)_0%,rgba(2,8,23,0.01)_68%,rgba(2,8,23,0.82)_94%,rgba(2,8,23,1)_100%)]" />
