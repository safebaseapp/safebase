  ...
  {[
    {
      ...
      desc:
        locale === "tr"
          ? "Tehlikeleri belirleyin ve riskleri değerlendirin."
    ...
    },
    {
      ...
      desc:
        locale === "tr"
          ? "Güvenli çalışma adımlarını ve kontrolleri tanımlayın."
    ...
    },
    {
      ...
      desc:
        locale === "tr"
          ? "Ekibinizi işe özel risk ve kontrollerle bilgilendirin."
    ...
    },
    {
      ...
      desc:
        locale === "tr"
          ? "Kontrolleri doğrudan sahada doğrulayın."
          : "Inspect and verify controls in the field.",
      dot: "bg-emerald-400",
    ...
    },
    {
      ...
      desc:
        locale === "tr"
          ? "Profesyonel çıktınızı oluşturun ve paylaşın."
          : "Generate and share professional output.",
      dot: "bg-violet-400",
    ...
    <div
      key={step.no}
      className="group relative rounded-2xl border border-white/10 bg-[#07111f]/90 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.25)] transition duration-300 hover:-translate-y-1 hover:border-blue-500/35 hover:bg-[#091625]"
    >
      {index < 4 && (
        <div className="absolute -right-[18px] top-1/2 z-20 hidden h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-blue-500/30 bg-[#020817] text-lg text-blue-400 shadow-lg xl:flex">
          →
        </div>
      )}
      ...
      <div className="flex items-center justify-between">
        <div
          className={`flex h-11 min-w-11 items-center justify-center rounded-xl border border-blue-500/20 bg-blue-500/10 px-2 text-[11px] font-black ${step.text}`}
        >
          {step.short}
        </div>
      ...
      <div className="mt-5 rounded-xl border border-white/[0.07] bg-[#030b16] p-4">
        ...
        <div className="space-y-2">
          ...
          <div className="h-1.5 w-[82%] rounded-full bg-white/[0.07]" />
