  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#020817]">
        <div className="absolute inset-0 -z-30 overflow-hidden bg-[#020817]">
  <img
    src="/images/sernem-hse-hero-final.png"
    alt=""
    aria-hidden="true"
    className="absolute inset-y-0 right-[-8%] h-full w-auto max-w-none object-contain"
  />
</div>
        ...
        <div className="absolute inset-0 -z-20 bg-[linear-gradient(180deg,rgba(2,8,23,0.03)_0%,rgba(2,8,23,0.00)_72%,rgba(2,8,23,0.55)_100%)]" />
