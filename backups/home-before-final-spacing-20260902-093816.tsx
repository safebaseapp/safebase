  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#020817]">
        <div className="absolute inset-0 -z-30 bg-[#020817]" />
        ...
        <div className="mx-auto max-w-[1440px] px-6 pb-12 pt-12 lg:px-8 lg:pb-14 lg:pt-14">
          <div className="grid items-center gap-10 lg:grid-cols-[0.88fr_1.12fr] xl:gap-16">
            <div className="relative z-10">
              ...
              <h1 className="mt-5 max-w-[680px] text-[42px] font-black leading-[0.98] tracking-[-0.055em] text-white sm:text-[54px] lg:text-[58px] xl:text-[66px]">
                {isTurkish ? (
                  <>
                    HSE çalışmalarınızı
              ...
              <div className="mt-8 grid max-w-[650px] grid-cols-2 gap-x-6 gap-y-5 sm:grid-cols-4">
                {[
                  {
                    icon: "◷",
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <Link
                  href={`/${locale}/tools`}
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-black text-white shadow-xl shadow-blue-600/20 transition hover:-translate-y-1 hover:bg-blue-500"
                >
                ...
                <Link
                  href={`/${locale}/upgrade`}
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-amber-400/30 bg-amber-400/[0.06] px-6 py-3.5 text-sm font-black text-amber-300 transition hover:-translate-y-1 hover:bg-amber-400/[0.1]"
                >
                  👑 Premium
                </Link>
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/[0.04] px-6 py-3.5 text-sm font-black text-white transition hover:-translate-y-1 hover:border-white/25 hover:bg-white/[0.08]"
                >
                  <ShieldCheck size={18} />
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-[26px] border border-white/15 bg-[#07111f] p-2 shadow-[0_40px_100px_rgba(0,0,0,.6)]">
                  <div className="overflow-hidden rounded-[20px] border border-white/[0.06] bg-[#050c18]">
                    ...
                    <div className="grid min-h-[410px] grid-cols-[118px_1fr] sm:grid-cols-[145px_1fr]">
