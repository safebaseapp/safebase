  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#020817]">
        ...
        <div className="mx-auto max-w-[1440px] px-6 pb-10 pt-10 lg:px-8 lg:pb-12 lg:pt-12">
          <div className="grid items-center gap-8 lg:grid-cols-[0.98fr_1.02fr] xl:gap-12">
            <div className="relative z-10">
              ...
              <h1 className="mt-5 max-w-[720px] text-[42px] font-black leading-[0.97] tracking-[-0.055em] text-white sm:text-[52px] lg:text-[54px] xl:text-[60px]">
                {isTurkish ? (
                  <>
                    HSE çalışmalarınızı
